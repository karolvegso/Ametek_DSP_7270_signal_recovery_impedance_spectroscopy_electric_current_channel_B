...
path_to_folder = 'd:/Python/Ametek_DSP_7270_signal_recovery/impedance_spectroscopy/text_file/08_FET_amp_1V_fast_scan/'
# path to text file to save data
root_name_file = 'ametek_dsp_7270_impedance_spect'
# path to file with TC / time constants
path_to_TC_file='d:/Python/Ametek_DSP_7270_signal_recovery/impedance_spectroscopy/TC_command_table_noisemode_off/TC_command_table_noisemode_off.txt'
...
# current mode on, voltage mode input disabled
# connect signal to B(I)
# high bandwidth current mode enabled = 1
# low noise current mode enabled  = 2
ametek_inst.write('IMODE 1')
time.sleep(1)
# FET input selection
# 0 Bipolar
# 1 FET
...
# wnable 50 or 60 Hz notch filter
